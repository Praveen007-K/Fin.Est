...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Edge-to-edge with light system-bar icons: the app is dark-only, so letting the platform
        // infer the icon colour from the (light) default would make the status bar unreadable.
        enableEdgeToEdge(
